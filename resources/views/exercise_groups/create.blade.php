...
@section('content')
    <div class="container-fluid pt-4 px-4" style="min-height: 82.5vh">
        <form action="{{ route('exercise-groups.store') }}" method="POST" enctype="multipart/form-data" id="exerciseGroupForm">
            @csrf
            <div class="row g-4">
                <!-- Group Info Card -->
                <div class="col-lg-4">
                    <div class="bg-light rounded p-4 h-100 shadow-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="sub_title" id="sub_title" class="form-control" value="{{ old('sub_title', 'Popular by Sport') }}" placeholder="e.g. Popular by Sport, Essential Training">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Displays on the mobile top banner card.</small>
                        ...
                        <div class="mt-4 pt-3 border-top d-grid">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-save me-2"></i>Save Exercise Group</button>
                        </div>
                    </div>
                </div>
