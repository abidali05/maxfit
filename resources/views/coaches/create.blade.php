        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-light rounded p-4">
                    <h4>Add Coach</h4>
                    <form action="{{ route('coaches.store') }}" method="POST" enctype="multipart/form-data" id="coachForm">
                        @csrf
                        <div class="mb-3">
                            <label>Name</label>
                        ...
                        <button type="submit" class="btn btn-primary" id="submitBranch">Save</button>
