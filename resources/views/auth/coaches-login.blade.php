    ...
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100 bg-light">
        <div class="col-md-4 bg-white p-4 rounded shadow">
            ...
            <div class="d-flex gap-2 mt-3">
                <a href="{{ route('login') }}" class="btn btn-sm btn-outline-primary flex-fill">Admin</a>
                <a href="{{ route('coaches.login') }}" class="btn btn-sm btn-primary flex-fill">Coach</a>
            </div>

            <form method="POST" action="{{ route('coaches.login.submit') }}" class="mt-4">
                @csrf
