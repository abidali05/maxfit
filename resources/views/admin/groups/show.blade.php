...
@section('content')
    <div class="container-fluid pt-4 px-4" style="min-height: 82.5vh">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4 border-bottom pb-3">
            <div>
                <a href="{{ route('groups.index') }}" class="btn btn-sm btn-outline-secondary mb-2">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.reports.index', ['group_id' => $group->id]) }}" class="btn btn-outline-primary btn-sm">
                    <i class="fa fa-chart-line me-1"></i>View Submissions Report
                </a>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-4 col-md-5">
                <div class="bg-light rounded p-4 h-100 shadow-sm">
                    ...
                    <div class="mb-2">
                        <label class="text-muted d-block small">Assigned Coach</label>
                        <span class="fw-bold text-dark fs-6">{{ $group->coach->name ?? 'N/A' }}</span>
                    </div>
                    <div class="mb-3">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="bg-light rounded p-4 h-100 shadow-sm">
                    ...
                    <form action="{{ route('groups.assign-exercises', $group->id) }}" method="POST" id="scheduleForm">
                        @csrf
